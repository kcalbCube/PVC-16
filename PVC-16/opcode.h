...
inline OpcodeFormat getOpcodeFormat(const Opcode opcode)
{
	switch (opcode)
	{
		...
		OPCODEFORMAT_CASE(PREINC01, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(PREINC10, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(PREINC11, OPCODE_PREFIX);
	
		OPCODEFORMAT_CASE(POSTINC01, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(POSTINC10, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(POSTINC11, OPCODE_PREFIX);
