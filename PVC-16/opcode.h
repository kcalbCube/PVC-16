...
inline OpcodeFormat getOpcodeFormat(const Opcode opcode)
{
	switch (opcode)
	{
		...
		OPCODEFORMAT_CASE(CMP_MC, OPCODE_MC);
		OPCODEFORMAT_CASE(CMP_MR, OPCODE_MR);
		OPCODEFORMAT_CASE(CMP_MM, OPCODE_MM);
		OPCODEFORMAT_CASE(CMP_RM, OPCODE_RM);
		OPCODEFORMAT_CASE(CMP_MC8, OPCODE_MC8);
		OPCODEFORMAT_CASE(CMP_MM8, OPCODE_MM);
		...
		OPCODEFORMAT_CASE(SHL_RC, OPCODE_RC);
		OPCODEFORMAT_CASE(SHR_RC, OPCODE_RC);
		OPCODEFORMAT_CASE(SHR_RR, OPCODE_RR);
		OPCODEFORMAT_CASE(OR_RR, OPCODE_RR);
		OPCODEFORMAT_CASE(OR_RC, OPCODE_RC);
		...
		OPCODEFORMAT_CASE(AND_RC, OPCODE_RC);
		OPCODEFORMAT_CASE(XOR_RR, OPCODE_RR);
		OPCODEFORMAT_CASE(XOR_RC, OPCODE_RC);
		OPCODEFORMAT_CASE(TEST_RR, OPCODE_RR);
		
		OPCODEFORMAT_CASE(CZ, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CNZ, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CG, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CNG, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CGZ, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CL, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CB, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CNB, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CBZ, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CA, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CAR, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CNAR, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CCR, OPCODE_PREFIX);
		OPCODEFORMAT_CASE(CNCR, OPCODE_PREFIX);
